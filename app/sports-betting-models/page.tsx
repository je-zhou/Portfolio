...
export default function SportsBettingModels() {
      ...
      <div className="flex min-h-screen max-w-full flex-col items-center bg-light-background dark:bg-charade">
        ...
        <div className="flex flex-col items-center px-4 md:px-24">
          <InfoTile
            ...
            display={
              <div className="h-[40vw] md:h-[25vw] relative w-full md:w-[100%]">
                <iframe
                  className="w-full h-full"
                  src="https://www.youtube.com/embed/2kDTwP6SBx4"
          ...
          {/* NextProejct */}
          <div className="py-32">
            <NextProject url="/021" text="021"></NextProject>
          </div>
        </div>
      </div>
    </main>
