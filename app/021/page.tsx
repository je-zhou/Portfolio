      ...
      <div className="flex min-h-screen max-w-full flex-col items-center bg-light-background dark:bg-charade">
        ...
        <div className="flex flex-col items-center px-4 md:px-24">
          <InfoTile
            ...
            description={
              "This started as a project to support some of my friends who were looking to open up small businesses and didn't want to have to pay a premium for the Shopify platform while not having the freedom to build custom, on brand websites outside the limitations of the stock standard website builder.\nTherefore 021 was born, an e-commerce platform designed to help businesses go from 0 to setting up their first shop online."
            }
            display={
          ...
          {/* NextProejct */}
          <div className="py-32">
            <NextProject url="/lynk" text="Lynk"></NextProject>
          </div>
        </div>
      </div>
    </main>
