	...
	return (
		<div className='flex w-full max-w-4xl h-screen p-12 flex-col snap-start justify-center pt-72'>
			<div className='flex flex-col space-y-16 items-center justify-center mb-72'>
				<h1 className='text-4xl md:text-8xl font-bold text-charade dark:text-white'>Lets Connect!</h1>
				<div className='flex flex-row space-x-8 opacity-70 text-charade dark:text-white'>
