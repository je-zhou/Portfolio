  ...
  return (
    <div className="flex flex-col lg:flex-row w-full px-4 md:px-16 items-start justify-center">
      ...
      <div className="flex-1 flex-col h-full w-full hidden lg:flex px-20">
        <AnimateImage imageURL="/projects/mycryptopocket/MyCryptoPocket - 1.png" />
        <AnimateImage imageURL="/projects/mycryptopocket/MyCryptoPocket - 2.png" />
        <AnimateImage imageURL="/projects/mycryptopocket/MyCryptoPocket - 3.png" />
        <AnimateImage imageURL="/projects/mycryptopocket/MyCryptoPocket - 4.png" />
      </div>
    </div>
  );
}
