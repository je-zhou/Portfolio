  ...
  return (
    <div className="flex flex-col lg:flex-row w-full px-4 md:px-16 items-start justify-center">
      <ProjectTile
        ...
        websiteUrl="https://www.021.au/"
      ></ProjectTile>
      <div className="flex-1 flex-col h-full w-full hidden lg:flex px-20">
        <AnimateImage imageURL="/projects/021/021 - 8.png" horizontal={true} />
        <AnimateImage imageURL="/projects/021/021 - 7.png" horizontal={true} />
        <AnimateImage imageURL="/projects/021/021 - 1.png" horizontal={true} />
        <AnimateImage imageURL="/projects/021/021 - 2.png" horizontal={true} />
        <AnimateImage imageURL="/projects/021/021 - 4.png" horizontal={true} />
      </div>
    </div>
  );
}
